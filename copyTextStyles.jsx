...
if (aeVersionHigherThan("24.0.00")) {
  copyTextStylesMograph_v24(app.project.activeItem.selectedLayers[0]);
} else {
  copyTextStylesMograph_v23(app.project.activeItem.selectedLayers[0]);
}
...
function copyTextStylesMograph_v23(layer) {
  if (!(isSecurityPrefSet())) {
    ...
    var textLayer = layer.property("ADBE Text Properties");
    ...
    var textObj = {
      ...
      "aeVersion": app.version.split(".")[0],
      "anchorPointGrouping": moreOptions.property("ADBE Text Anchor Point Option").value,
      "groupingAlignment": moreOptions.property("ADBE Text Anchor Point Align").value,
      "fillAndStroke": moreOptions.property("ADBE Text Render Order").value,
      "interCharacterBlending": moreOptions.property("ADBE Text Character Blend Mode").value
    };
...
function copyTextStylesMograph_v24(layer) {
  if (!(isSecurityPrefSet())) {
    ...
    var textObj = {
      ...
      "applyFill": textDocument.applyFill,
      "applyStroke": textDocument.applyStroke,
      "autoHyphenate": textDocument.autoHyphenate,
      "autoKernType": textDocument.autoKernType,
      "autoLeading": textDocument.autoLeading,
      "baselineDirection": textDocument.baselineDirection,
      "baselineLocs": textDocument.baselineLocs,
      "baselineShift": textDocument.baselineShift,
      "boxText": textDocument.boxText,
      "boxTextPos": (textDocument.boxText == true) ? textDocument.boxTextPos : null,
      "boxTextSize": (textDocument.boxText == true) ? textDocument.boxTextSize : null,
      "composerEngine": textDocument.composerEngine,
      "digitSet": textDocument.digitSet,
      "direction": textDocument.direction,
      "endIndent": textDocument.endIndent,
      "everyLineComposer": textDocument.everyLineComposer,
      "fauxBold": textDocument.fauxBold,
      "fauxItalic": textDocument.fauxItalic,
      "fillColor": "",
      "firstLineIndent": textDocument.firstLineIndent,
      "font": textDocument.font,
      "fontBaselineOption": textDocument.fontBaselineOption,
      "fontCapsOption": textDocument.fontCapsOption,
      "fontFamily": textDocument.fontFamily,
      "fontLocation": textDocument.fontLocation,
      "fontObject": textDocument.fontObject,
      "fontSize": textDocument.fontSize,
      "fontStyle": textDocument.fontStyle,
      "hangingRoman": textDocument.hangingRoman,
      "horizontalScale": textDocument.horizontalScale,
      "justification": textDocument.justification,
      "kerning": textDocument.kerning,
      "leading": textDocument.leading,
      "leadingType": textDocument.leadingType,
      "ligature": textDocument.ligature,
      "lineJoinType": textDocument.lineJoinType,
      "noBreak": textDocument.noBreak,
      "pointText": textDocument.pointText,
      "smallCaps": textDocument.smallCaps,
      "spaceAfter": textDocument.spaceAfter,
      "spaceBefore": textDocument.spaceBefore,
      "startIndent": textDocument.startIndent,
      "strokeColor": "",
      "strokeOverFill": textDocument.strokeOverFill,
      "strokeWidth": textDocument.strokeWidth,
      "subscript": textDocument.subscript,
